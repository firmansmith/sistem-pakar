...
class Mahasiswa extends Super //class mengikuti nama file. diawali dengan huruf besar
{
    ...
    function __construct()
    {
        ...
        $this->tabel          = "mahasiswa"; //nama tabel sesuai dengan nama yg ada di database
        $this->active_id_menu = "Mahasiswa";
        $this->nama_view      = "Mahasiswa"; //tampilan untuk di view
        $this->status         = true; 
