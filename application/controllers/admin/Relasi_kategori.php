...
class Relasi_kategori extends Super
{
    ...
    function __construct()
    {
        ...
        $this->tabel          = "relasi_kategori";
        $this->active_id_menu = "Relasi kategori";
        $this->nama_view      = "Relasi kategori";
        $this->status         = true; 
    ...
    function index(){
            ...
            **/
            $this->crud->set_relation('id_soal','soal','soal');
            $this->crud->set_relation('id_kategori','kategori','kategori');
            $this->crud->set_relation('id_jawaban','jawaban','jawaban');
            ...
            $this->crud->display_as('id_soal','Soal'); 
            $this->crud->display_as('id_jawaban','Jawaban'); 
